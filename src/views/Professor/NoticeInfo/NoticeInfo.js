        ...
        >
          <TableContainer component={Paper}>
            <Table aria-label="simple table">
              <TableHead>
                <TableRow>
                  <TableCell colSpan="4" align="center"><h1>* 공지사항 등 록</h1><span className={classes.requireFont}>*5분마다 자동으로 임시저장 됩니다.</span></TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                <TableRow>
                ...
                <TableRow>
                  <TableCell align="center"><h2>공지사항 제목</h2><span className={classes.requireFont}>*필수 입력 값입니다</span></TableCell>
                  <TableCell colSpan="3" align="left"><TextField fullWidth variant="outlined" /></TableCell>
                </TableRow>
                <TableRow>
                ...
                <TableRow>
                  <TableCell align="center"><h2>공지사항 내용</h2></TableCell>
